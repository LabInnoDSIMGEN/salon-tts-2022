...
Sélectionnez un créneau pour un rendez-vous avec l'intérvenant disponible : `,[{label:`Mathieu GOULIN 
 Lundi 27 Mars 
 14h-15h`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 27, 2023 14:00"),new Date("Mar 27, 2023 15:00"),"TTS 11","Services dans le Cloud, introduction et notre utilisation à venir","Salon des TTS"," DSI MGEN","Metavers")}},{label:`Mathieu GOULIN 
 Jeudi 30 Mars 
 10h-11h`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 30, 2023 10:00"),new Date("Mar 30, 2023 11:00"),"TTS 11","Services dans le Cloud, introduction et notre utilisation à venir","Salon des TTS"," DSI MGEN","Metavers")}},{label:"Fermer",className:"primary",callback:()=>{u()}}])}),WA.room.area.onEnter("tts12Zone").subscribe(()=>{m=WA.ui.openPopup("tts12Popup",`TTS 12 
 Présenté par 
 Roxanne SPIES 
Sélectionnez un créneau pour un rendez-vous avec l'intérvenant disponible : `,[{label:`Roxanne SPIES 
 Mercredi 29 Mars 
 10h-11h`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 29, 2023 10:00"),new Date("Mar 29, 2023 11:00"),"TTS 12","Design System et DesignOps, quand le Design s'opérationnalise et s'adpte au mode Agile","Salon des TTS"," DSI MGEN","Metavers")}},{label:`Roxanne SPIES 
 Jeudi 30 Mars 
 16h30-17h30`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 30, 2023 16:30"),new Date("Mar 30, 2023 17:30"),"TTS 12","Design System et DesignOps, quand le Design s'opérationnalise et s'adpte au mode Agile","Salon des TTS"," DSI MGEN","Metavers")}},{label:"Fermer",className:"primary",callback:()=>{u()}}])}),WA.room.area.onEnter("tts13Zone").subscribe(()=>{m=WA.ui.openPopup("tts13Popup",`TTS 13 
 Présenté par 
 Cyril Carrillat 
 Marie Cordenod 
...
`,[{label:`Lundi 27 Mars 
14h-15h`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 31, 2023 14:00"),new Date("Mar 31, 2023 15:00"),"TTS 16","La Data Science au service des métiers et au cœur de la transformation MGEN","Salon des TTS","DSI MGEN","Metavers")}},{label:`Mercredi 29 Mars 
14h-15h`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 29, 2023 14:00"),new Date("Mar 29, 2023 15:00"),"TTS 16","La Data Science au service des métiers et au cœur de la transformation MGEN","Salon des TTS","DSI MGEN","Metavers")}},{label:`Jeudi 30 Mars 
14h-15h`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 30, 2023 14:00"),new Date("Mar 30, 2023 15:00"),"TTS 16","La Data Science au service des métiers et au cœur de la transformation MGEN","Salon des TTS","DSI MGEN","Metavers")}},{label:`Vendredi 31 Mars 
10h30-12h`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 31, 2023 10:30"),new Date("Mar 31, 2023 12:00"),"TTS 16","La Data Science au service des métiers et au cœur de la transformation MGEN","Salon des TTS","DSI MGEN","Metavers")}}])}),WA.room.area.onEnter("tts17.1Zone").subscribe(()=>{m=WA.ui.openPopup("tts17.1Popup",`TTS 17.1 :
 Présenté par 
 Alizée SEGARD
 Mansour YOUM
 Virginie FEMERY 
Sélectionnez un créneau pour un rendez-vous avec l'intervenant disponible :`,[{label:`Mardi 28 Mars 
11h-12h`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 28, 2023 11:00"),new Date("Mar 28, 2023 12:00"),"TTS 17.1","Les tendances en e-santé : Les thérapies Digitales (DTx)","Salon des TTS","DSI MGEN","Metavers")}},{label:`Vendredi 31 Mars 
11h-12h`,className:"primary",callback:()=>{T("Romance Standard Time",new Date("Mar 31, 2023 11:00"),new Date("Mar 31, 2023 12:00"),"TTS 17.1","Les tendances en e-santé : Les thérapies Digitales (DTx)","Salon des TTS","DSI MGEN","Metavers")}},{label:"Fermer",className:"primary",callback:()=>{u()}}])}),WA.room.area.onEnter("officeZone").subscribe(()=>{m=WA.ui.openPopup("officePopup","Venez ici pour échanger avec l'équipe du Lab Inno",[{label:"Fermer",className:"primary",callback:()=>{u()}}])}),WA.room.area.onEnter("librarySignTTS1").subscribe(()=>{m=WA.ui.openPopup("librarySignPopupTTS1",`Ressources de TTS N°1 : L'automatisation robotisée des process (RPA) 
...
Agnès CHATELLE 
(Direction Digitale)
`,[{label:"Fermer",className:"primary",callback:()=>{u()}}])}),WA.room.area.onEnter("librarySignTTS6.2").subscribe(()=>{m=WA.ui.openPopup("librarySignPopupTTS6.2",`Ressources de TTS N°6.2 : Cadrer et Piloter les cas d'usage dans les mutuelles et les assurances 
